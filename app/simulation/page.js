          ...
          <div style={{ maxWidth: '850px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '3rem' }}>
              ...
              <div className="glass" style={{ padding: '2rem', borderRadius: '8px' }}>
                <h3 className="font-display" style={{ fontSize: '1.25rem', fontWeight: 800, marginBottom: '1.5rem', textTransform: 'uppercase', color: 'var(--text-primary)' }}>Debate Parameters</h3>

                {/* Topic selection */}
                <div style={{ marginBottom: '1.25rem' }}>
                  <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>Select Debate Topic</label>
                  <select 
                    value={topic} 
                    onChange={(e) => setTopic(e.target.value)}
                    style={{ width: '100%', padding: '0.75rem', border: '1px solid var(--border-light)', outline: 'none', background: 'var(--dark-bg)', color: 'var(--text-primary)', fontSize: '0.9rem', borderRadius: '4px' }}
                  >
                ...
                {topic === "Custom Topic (Enter below)" && (
                  <div style={{ marginBottom: '1.25rem' }}>
                    <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>Enter Custom Topic Title</label>
                    <input 
                      type="text"
                      placeholder="e.g., Space exploration should be prioritized over deep ocean research."
                      value={customTopic}
                      onChange={(e) => setCustomTopic(e.target.value)}
                      style={{ width: '100%', padding: '0.75rem', border: '1px solid var(--border-light)', outline: 'none', background: 'var(--dark-bg)', color: 'var(--text-primary)', fontSize: '0.9rem', boxSizing: 'border-box', borderRadius: '4px' }}
                    />
                  </div>
                )}
                ...
                <div style={{ marginBottom: '1.25rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>Debate Format</label>
                    <select 
                      value={format} 
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>Assigned Position</label>
                    <select 
                      value={position} 
                ...
                <div style={{ marginBottom: '1.5rem' }}>
                  <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '0.4rem' }}>Opponent Persona</label>
                  <select 
                    value={persona} 
              ...
              <div className="glass" style={{ padding: '2rem', borderRadius: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  ...
                  {scheduleSuccess && (
                    <div style={{ background: 'rgba(255, 51, 102, 0.1)', border: '1px solid var(--accent-red)', padding: '0.75rem', fontSize: '0.8rem', color: 'var(--text-primary)', marginBottom: '1.5rem', borderRadius: '4px' }}>
                      {scheduleSuccess}
                    </div>
                  )}
                  ...
                  <form onSubmit={handleSchedulePractice}>
                    <div style={{ marginBottom: '1rem' }}>
                      <label style={{ display: 'block', fontSize: '0.78rem', color: 'var(--text-muted)', marginBottom: '0.4rem', textTransform: 'uppercase' }}>Practice Date</label>
                      <input 
                        type="date"
                        required
                        value={scheduledDate}
                        onChange={(e) => setScheduledDate(e.target.value)}
                        style={{ width: '100%', padding: '0.75rem', border: '1px solid var(--dark-border)', outline: 'none', background: 'var(--dark-bg)', color: 'var(--text-primary)', fontSize: '0.9rem', boxSizing: 'border-box', borderRadius: '4px' }}
                      />
                    </div>

                    <div style={{ marginBottom: '1.5rem' }}>
                      <label style={{ display: 'block', fontSize: '0.78rem', color: 'var(--text-muted)', marginBottom: '0.4rem', textTransform: 'uppercase' }}>Practice Time</label>
                      <input 
                        type="time"
                        required
                        value={scheduledTime}
                    ...
                    <button 
                      ...
                      style={{ width: '100%', padding: '0.75rem', transition: 'all var(--transition-fast)' }}
                    >
