...
export default function DashboardPage() {
  ...
  return (
    <div className="section-container" style={{ paddingTop: '2.5rem', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2.5rem', borderBottom: '1px solid var(--border-light)', paddingBottom: '1.5rem' }}>
        <div>
          <div style={{ display: 'inline-block', background: 'rgba(255, 51, 102, 0.1)', color: 'var(--accent-red)', fontSize: '0.75rem', fontWeight: 700, padding: '0.3rem 0.75rem', borderRadius: '4px', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.6rem' }}>
            ROUTER SESSION ACTIVE // ROLE: {userRole.toUpperCase()}
          </div>
          <h1 className="font-display" style={{ fontSize: '3rem', fontWeight: '900', textTransform: 'uppercase', lineHeight: '1.1', color: 'var(--text-primary)' }}>
            Welcome, {userName || 'User'}
          </h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '0.25rem' }}>Account email: {userEmail}</p>
        </div>
        <button onClick={handleLogout} className="btn btn-login" style={{ padding: '0.6rem 1.4rem', fontSize: '0.8rem', fontWeight: 700 }}>
          LOGOUT
        </button>
      </div>
      ...
      {userRole === 'Learner' && (
        <div className="glass" style={{ display: 'flex', gap: '0.5rem', padding: '6px', marginBottom: '2.5rem', overflowX: 'auto', whiteSpace: 'nowrap', borderRadius: '8px' }}>
          {[
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                background: activeTab === tab.id ? 'var(--dark-bg)' : 'transparent',
          ...
          {activeTab === 'overview' && (
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', marginBottom: '2.5rem' }}>
                <div className="glass" style={{ padding: '1.75rem', borderRadius: '8px' }}>
                  <div className="font-mono text-muted" style={{ fontSize: '0.75rem', marginBottom: '0.4rem' }}>DEBATES COMPLETED</div>
                  <div className="font-display" style={{ fontSize: '2.2rem', fontWeight: '900', color: 'var(--text-primary)' }}>14</div>
                </div>
                <div className="glass" style={{ padding: '1.75rem', borderRadius: '8px' }}>
                  <div className="font-mono text-muted" style={{ fontSize: '0.75rem', marginBottom: '0.4rem' }}>AVG OVERALL SCORE</div>
                  <div className="font-display" style={{ fontSize: '2.2rem', fontWeight: '900', color: 'var(--accent-red)' }}>88.5%</div>
                </div>
                <div className="glass" style={{ padding: '1.75rem', borderRadius: '8px' }}>
                  <div className="font-mono text-muted" style={{ fontSize: '0.75rem', marginBottom: '0.4rem' }}>ACTIVE DRILL STATUS</div>
                  <div className="font-display" style={{ fontSize: '2.2rem', fontWeight: '900', color: 'var(--text-primary)' }}>Level 2</div>
                </div>
                <div className="glass" style={{ padding: '1.75rem', borderRadius: '8px' }}>
                  <div className="font-mono text-muted" style={{ fontSize: '0.75rem', marginBottom: '0.4rem' }}>TOP AVOIDED FALLACY</div>
                  <div className="font-display" style={{ fontSize: '1.8rem', fontWeight: '900', textTransform: 'uppercase', color: 'var(--text-primary)' }}>Straw Man</div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: '2.5rem' }}>
                ...
                <div className="glass" style={{ padding: '2rem', borderRadius: '8px' }}>
                  <h3 className="font-display" style={{ fontSize: '1.4rem', fontWeight: 900, textTransform: 'uppercase', marginBottom: '1.5rem', color: 'var(--text-primary)' }}>Rhetorical Skill Matrix</h3>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    {skillsMatrix.map((skill, i) => (
                      <div key={i}>
                        ...
                        {/* Bar */}
                        <div style={{ width: '100%', height: '8px', background: 'var(--dark-bg)', borderRadius: '4px', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                  ...
                  <div className="glass" style={{ padding: '2rem', borderRadius: '8px' }}>
                    <div className="font-mono" style={{ fontSize: '0.75rem', marginBottom: '0.5rem', color: 'var(--accent-cyan)' }}>COACHING ENGINE INSIGHTS</div>
                    <h3 className="font-display" style={{ fontSize: '1.25rem', fontWeight: 800, textTransform: 'uppercase', marginBottom: '1rem', color: 'var(--text-primary)' }}>Active Plan: {progressStatus}</h3>
                    <p style={{ fontSize: '0.88rem', color: 'var(--text-secondary)', lineHeight: '1.5', marginBottom: '1.5rem' }}>{skillGapSummary}</p>
                    
                    <div className="font-mono" style={{ fontSize: '0.72rem', marginBottom: '0.5rem', color: 'var(--accent-cyan)' }}>ACTIVE LEARNING STEP</div>
                    <div style={{ fontSize: '0.9rem', color: 'var(--text-primary)', fontWeight: 600 }}>{pathSteps[0]}</div>
                  </div>

                  {/* Recommendations Exercise list */}
                  <div className="glass" style={{ padding: '2rem', borderRadius: '8px' }}>
                    <h4 className="font-display" style={{ fontSize: '1.1rem', fontWeight: 800, textTransform: 'uppercase', marginBottom: '1rem', color: 'var(--text-primary)' }}>Recommended Practice drills</h4>
                    <ul style={{ paddingLeft: '1.2rem', margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.88rem', color: 'var(--text-secondary)', lineHeight: '1.4' }}>
