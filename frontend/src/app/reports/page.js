    ...
    <>
      ...
      <div className="section-container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
          ...
          <div style={{ border: '1px solid var(--border-light)', padding: '2rem', background: '#fff', borderRadius: '16px', boxShadow: '0 8px 24px rgba(0,0,0,0.03)' }}>
            ...
            <button onClick={handleDownloadPDF} className="btn btn-red" style={{ width: '100%', borderRadius: '8px', cursor: 'pointer' }}>
          ...
          <div style={{ border: '1px solid var(--border-light)', padding: '2rem', background: '#fff', borderRadius: '16px', boxShadow: '0 8px 24px rgba(0,0,0,0.03)' }}>
            ...
            <button onClick={handleDownloadExcel} className="btn btn-dark" style={{ width: '100%', borderRadius: '8px', cursor: 'pointer' }}>
          ...
          <div style={{ border: '1px solid var(--border-light)', padding: '2rem', background: '#fff', borderRadius: '16px', boxShadow: '0 8px 24px rgba(0,0,0,0.03)' }}>
            ...
            <button onClick={handleDownloadCoachingPDF} className="btn btn-dark" style={{ width: '100%', borderRadius: '8px', cursor: 'pointer' }}>
