    ...
    <div className="section-container">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
        ...
        <div style={{ border: '1px solid var(--border-light)', padding: '2rem', background: '#fff' }}>
          ...
          <button onClick={() => window.open("http://localhost:8000/api/v1/reports/export/audit/3", "_blank")} className="btn btn-dark" style={{ width: '100%' }}>
            EXPORT AUDIT REPORT
          </button>
        </div>
        ...
        <div style={{ border: '1px solid var(--border-light)', padding: '2rem', background: '#fff' }}>
          ...
          <button onClick={() => window.open("http://localhost:8000/api/v1/reports/export/certificate/3", "_blank")} className="btn btn-red" style={{ width: '100%' }}>
